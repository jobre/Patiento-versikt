...
namespace Ortoped.Thord.ThordHelpClasses //Microsoft.WCF.Documentation
{
    public class InspectorInserter : BehaviorExtensionElement, IServiceBehavior, IEndpointBehavior, IOperationBehavior
    {
        private string mUser = "test", mPassword = "qweQWE123";
        #region IServiceBehavior Members
        public void AddBindingParameters(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase,System.Collections.ObjectModel.Collection<ServiceEndpoint> endpoints,BindingParameterCollection bindingParameters) { return; }
        ...
        public void ApplyDispatchBehavior(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase)
        {
            foreach (ChannelDispatcher chDisp in serviceHostBase.ChannelDispatchers)
            {
                ...
                {
                    epDisp.DispatchRuntime.MessageInspectors.Add(new PasswordDigestMessageInspector(mUser, mPassword));
                    foreach (DispatchOperation op in epDisp.DispatchRuntime.Operations)
                        op.ParameterInspectors.Add(new PasswordDigestMessageInspector(mUser, mPassword));
                }
            }
        }
        ...
        {
            clientRuntime.MessageInspectors.Add(new PasswordDigestMessageInspector(mUser, mPassword));
        ...
        {
            endpointDispatcher.DispatchRuntime.MessageInspectors.Add(new PasswordDigestMessageInspector(mUser, mPassword));
        ...
        {
            clientOperation.ParameterInspectors.Add(new PasswordDigestMessageInspector(mUser, mPassword));
        }

        public void ApplyDispatchBehavior(OperationDescription operationDescription, DispatchOperation dispatchOperation)
        {
            dispatchOperation.ParameterInspectors.Add(new PasswordDigestMessageInspector(mUser, mPassword));
        }
    ...
    public class PasswordDigestMessageInspector : IClientMessageInspector, IParameterInspector, IDispatchMessageInspector
    {
        ...
        {
            this.Username = Ortoped.HelpClasses.Config.ThordUserId;
            this.Password = Ortoped.HelpClasses.Config.ThordPassword;
